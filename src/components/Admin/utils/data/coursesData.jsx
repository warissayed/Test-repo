...
export const coursesData = [
  ...
  {
    _id: "664df3da71a55f6edce5ad0b",
    title: "Data Structure",
    description:
      "A Data Structures course is like embarking on a journey through the architecture of information. It's where you delve into the fundamental building blocks that empower efficient manipulation, storage, and retrieval of data within computer programs. This journey equips you with the tools to optimize algorithms and streamline processes, essential skills for any aspiring programmer or computer scientist .At its core, the course explores various data organization techniques, each tailored to specific scenarios, be it handling massive datasets or ensuring swift access to critical information. From the classic arrays and linked lists to more complex structures like trees, graphs, and hash tables, each data structure offers its unique advantages and trade-offs., and videos, and optimizing websites for various devices.",
    price: 0,
    imgSrc:
  ...
  {
    _id: "664df4e371a55f6edce5ad1b",
    title: "Data science and machine Learning",
    description:
      "Welcome to the exciting world of Data Science and Machine Learning! In this course, we will embark on a journey to explore the interdisciplinary field that combines techniques from statistics, computer science, and domain knowledge to extract insights and knowledge from Overview Data Science and Machine Learning are revolutionizing industries across the globe, from finance to healthcare, marketing to entertainment. This course will provide you with a comprehensive understanding of the fundamental concepts, techniques, and tools used in these fields.",
    price: 0,
    imgSrc:
